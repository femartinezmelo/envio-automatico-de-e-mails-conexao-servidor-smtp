...
senha = 'senha de app da sua conta'
destinatario = 'e-mail de quem você quer enviar'
assunto = 'Estudando Python'
corpo = """
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
class GerenciadorEmail:
    def __init__(self, remetente, senha, destinatario, assunto, corpo):
...
GerenciadorEmail(remetente, senha, destinatario, assunto, corpo).enviar_email()
